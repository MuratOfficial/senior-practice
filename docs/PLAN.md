...
- [ ] Задачи (challenges) внутри mock-сессии — сейчас только вопросы
...
**Результат:** ✅ полный цикл подготовки: учить → практиковать → повторять → симулировать интервью (завершено 2026-07-19; из фазы — только задачи внутри mock-сессий).
