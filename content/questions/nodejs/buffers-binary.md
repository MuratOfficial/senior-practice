...
followUps:
  - Чем Buffer.alloc отличается от Buffer.allocUnsafe и когда unsafe опасен?
  - Как связаны Buffer, Uint8Array и ArrayBuffer?
  - Почему нарезка мультибайтового UTF-8 по границе chunk ломает строку?
references:
