...
followUps:
  - Чем writable:false отличается от configurable:false?
  - Почему Object.freeze поверхностный и как сделать глубокую заморозку?
  - Как перечисляемость (enumerable) влияет на for...in, spread и JSON.stringify?
references:
